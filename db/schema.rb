...
ActiveRecord::Schema.define(version: 20164614172213) do
  ...
  create_table "memes", force: :cascade do |t|
    ...
    t.integer  "chatroom_player_id",  null: false
    t.integer  "chatroom_picture_id", null: false
    t.integer  "votes"
    t.boolean  "winner"
    t.datetime "created_at",          null: false
    t.datetime "updated_at",          null: false
    t.index ["chatroom_picture_id"], name: "index_memes_on_chatroom_picture_id", using: :btree
    t.index ["chatroom_player_id"], name: "index_memes_on_chatroom_player_id", using: :btree
  end
  ...
  create_table "messages", force: :cascade do |t|
    ...
    t.index ["chatroom_player_id"], name: "index_messages_on_chatroom_player_id", using: :btree
  end
  ...
  create_table "votes", force: :cascade do |t|
    ...
    t.datetime "created_at",         null: false
    t.datetime "updated_at",         null: false
    t.index ["chatroom_player_id"], name: "index_votes_on_chatroom_player_id", using: :btree
  ...
  add_foreign_key "memes", "chatroom_pictures"
  add_foreign_key "memes", "chatroom_players"
  add_foreign_key "messages", "chatroom_players"
  add_foreign_key "messages", "chatrooms"
  add_foreign_key "votes", "chatroom_players"
